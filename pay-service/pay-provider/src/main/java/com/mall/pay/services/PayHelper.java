...
import com.mall.pay.alipay.Main;
...
public class PayHelper extends Main {
    ...
    public String getQrCode(PaymentRequest request) {
        ...
        String totalAmount = String.valueOf(request.getTotalFee());
        ...
        String operatorId = "cskaoyan_zs";

        // (必填) 商户门店编号，通过门店号和商家后台可以配置精准到门店的折扣信息，详询支付宝技术支持
        String storeId = "cskaoyan_zs";
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                String filePath = String.format(codePath, response.getOutTradeNo());
